...
extraerTiempo("headlines/raw/el-tiempo-"+str(date_day.year)+"-"+str(date_day.strftime('%m'))+"-"+str(date_day.strftime('%d'))+".html")
extraerEspectador("headlines/raw/el-espectador-"+str(date_day.year)+"-"+str(date_day.strftime('%m'))+"-"+str(date_day.strftime('%d'))+".html")